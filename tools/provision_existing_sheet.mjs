...
if (!spreadsheetId || !svcEmail || !privateKey) throw new Error('Missing env keys');
...
const out = {
  ...
  imported: imports.map((i) => i.tab),
  adminSeedPhone: '01700000000',
  adminSeedPin: '1234',
};

const outFile = path.join(OUT_DIR, 'provisioned_existing_sheet.json');
fs.writeFileSync(outFile, JSON.stringify(out, null, 2), 'utf8');
console.log('Provision existing sheet done');
